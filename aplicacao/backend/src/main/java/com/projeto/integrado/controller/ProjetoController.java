...
public class ProjetoController {
	...
	@GetMapping 
	public ResponseEntity<Projeto> getByDescricao(@RequestParam("descricao")String descricao){
		return new ResponseEntity<>(projetoService.getByDescricao(descricao), HttpStatus.OK);
	}
